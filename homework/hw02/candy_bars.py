...
* negative values for profit are acceptable (well, not really, in that you've   lost money, but ok for how your program works). 
...
Implement this program any way you like (feel free to define or not define
functions). Example interaction is below. Every line that starts with ">"
...
> 2
After selling 32 candy bars, your total profit is $24.
"""
